...
module.exports = {
    ...
    inventory(object) {
        try {
            ...
            var pulse = object.Pulses;

            console.log("Inventory of Rice \n");
            ...
            for (var key in rice) {
                ...
                console.log("total weight in kg :", rice[key].weight + " kg");
                console.log("total price for " + rice[key].name + " is : Rs" + rice[key].price * rice[key].weight);
            }

            console.log("Inventory of Wheat \n");

            for (key in wheat) {
                console.log("\n");
                console.log(wheat[key]);

                console.log("price per kg : Rs", wheat[key].price);
                console.log("total weight in kg :", wheat[key].weight + " kg");
                console.log("total price for " + wheat[key].name + " is : Rs" + wheat[key].price * wheat[key].weight);
            }
            
            console.log("Inventory of Pulse \n");
            ...
            for (key in pulse) {
                ...
                console.log("total weight in kg :", pulse[key].weight + " kg");
    ...
    regex(name, fullName, mobile, date) {
        try {
            var fs = require('fs')

            var str = fs.readFileSync("regex.txt", "utf8");
            str = str.replace(/<<name>>/g, name);
            str = str.replace(/<<fullname>>/g, fullName);
            str = str.replace(/xxxxxxxxxx/g, mobile);
            str = str.replace(/<<xx-xx-xxxx>>/g, date);
    ...
    */
    ...
    stockReport(object) {
        try {
            ...
            for (key in stock) {
                console.log("Stock name : " + stock[key].stockName);
                console.log("number of stocks : " + stock[key].numberOfShares);
                console.log("amount of each share : " + stock[key].shareAmount);
                console.log("total value of " + stock[key].stockName + " shares of " + stock[key].numberOfShares + " is " + stock[key].shareAmount);
            }
        }
        catch (err) {
            console.log("ERROR : " + err);
   ...
   */
    ...
    */
    ...
    saveStock(data) {
        try {
            file.writeFileSync("inventoryFile.json", JSON.stringify(data));
        }
        catch (err) {
 ...
 */
    ...
    deckOfCardsQueue() {
        var queue = require("../../Data Structures/implementations/queueLinkedList");
        ...
        arr1 = person1.getData().split(" ");
        console.log(arr1);
        arr2 = person1.getData().split(" ");
        arr3 = person1.getData().split(" ");
        arr4 = person1.getData().split(" ");

        arr1 = arr1.sort();
        console.log(arr1);
        util.insertionSort(arr2);
        util.insertionSort(arr3);
        util.insertionSort(arr4);

        console.log("\n cards distributed among four players \n ")

        console.log("first player has : " + arr1);
        console.log("second player has : " + arr2);
        console.log("third player has : " + arr3);
        console.log("fourth player has : " + arr4);
    },
