...
class StockQueue extends Queue {
    ...
    buyQueue() {
        ...
        if (found == true) {
            ...
            this.queue.enqueue(NameOfCompany + "'s share bought on " + dd.getDate() + "/" +  (dd.getMonth() + 1) + "/" + dd.getFullYear() + " at " + dd.getHours() + ":" + dd.getMinutes() + ":" + dd.getSeconds());
        }
        else {
    ...
    sellQueue() {
        ...
        if (found == true) {
            ...
            this.queue.enqueue(NameOfCompany + "'s share sold on " + d.getDate() + "/" +  (d.getMonth() + 1) + "/" + d.getFullYear() + " at " + d.getHours() + ":" + d.getMinutes() + ":" + d.getSeconds());
        }
        else {
            console.log("Company not found");
        }
