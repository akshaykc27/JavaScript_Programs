...
module.exports = {
    ...
    */
    ...
    /************************************************************************************/
        ...
        leapYear1(year)          //To find a leap year...
        {
        if (year%4 ==0 && year%100!=0 || year%400==0)
        {
            return true;
    ...
    // to return the numeber of days in a month
        monthof(m) {             
        switch (m) {
            case 1: return 31;
                break;
    ...
    month(m) {             //returns the month of according to the nmumber 
        switch (m) {
    ...
    // This method returns the prime numbers between the given range.
    ...
    // this method returns anagrams that are prime numbers in that given range.
